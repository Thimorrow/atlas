...
// In Next 16 sind Route- und Search-Params ein Promise. `thema` ist Pflicht
// (die Tutor-Session haengt am Thema), alles andere hat einen Default. Die
...
export default async function LernenTutorPage({
  ...
  searchParams: Promise<{ thema?: string; modus?: string; karte?: string; session?: string }>;
}) {
